...
export default function App() {
  ...
  const handleDeleteSelectedAccounts = async (ids: string[]) => {
    try {
      ...
      console.error('Failed to delete selected accounts:', err);
    }
  };
  ...
  // Export
  const handleExport = (format: 'csv' | 'json', selectedIds?: string[], excludeStatus?: string) => {
    ...
    <div className="min-h-screen bg-[#0A0A0C] text-[#F8F9FA] font-sans selection:bg-blue-600 selection:text-white flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <AccountsTable
          ...
          onDeleteSelectedAccounts={handleDeleteSelectedAccounts}
